// Cloudflare Pages Function — GET /api/merval
// Proxies BYMA index-price (CORS-blocked) with Yahoo Finance fallback

interface Env {}

const BYMA_URL = 'https://open.bymadata.com.ar/vanoms-be-core/rest/api/bymadata/free/index-price';
const YAHOO_URL = 'https://query1.finance.yahoo.com/v8/finance/chart/%5EMERV?interval=1d&range=1d';
...
export const onRequestGet: PagesFunction<Env> = async () => {
  try {
    ...
    return new Response(JSON.stringify({ error: err.message ?? 'Failed to fetch Merval data' }), {
      status: 502,
